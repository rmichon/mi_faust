...
in1 = vslider("position2",0,-1,1,0.0001) : si.smoo ;
in2 = vslider("position",0,-0.8,0.8,0.0001) : si.smoo ;
...
with{
RoutingLinkToMass(l0_f1,l0_f2,l1_f1,l1_f2,l2_f1,l2_f2) = l0_f1, l0_f2+l1_f2+l2_f2, l1_f1, in1, l2_f1, in2;
