...
str_M = 1.0;
str_K = hslider("stiffness",0.3,0.001,0.3,0.0001);
str_Z = hslider("damping",0.0006,0.00001,0.1,0.0001);
gain = hslider("gain",0.2,0,1,0.01);

oscK = hslider("osc stiffness",0.000005,0.0000001,0.1,0.0001);
oscDamp = hslider("osc damping",0.0008,0.000001,0.1,0.0001);
...
model = (RoutingLinkToMass,_,_,_,_ : 
ground(0.),
ground(0.),
mass(low_M,0., 0.),
mass(low_M,0., 0.),
